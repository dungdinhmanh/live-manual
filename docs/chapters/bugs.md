...
Remember to send in any logs that were produced with English locale settings, e.g. run your _live-build_ commands with a leading LC_ALL=C or LC_ALL=en_US.
