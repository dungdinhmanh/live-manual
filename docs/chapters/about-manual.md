...
-   Translate the **about_manual.ssi.pot**, **about_project.ssi.pot** and **index.html.in.pot** files in manual/pot/ to your language with your favourite editor (such as _poedit_) and send the translated .po files to the mailing list to check their integrity. _live-manual_'s integrity check not only ensures that the .po files are 100% translated but it also detects possible errors.
